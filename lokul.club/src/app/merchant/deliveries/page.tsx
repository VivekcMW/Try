                ...
                {isPending && (
                  <div className="flex flex-shrink-0 items-center gap-2">
                    ...
                    <button
                      ...
                      disabled={marking === delivery.id}
                      className="flex items-center gap-1.5 rounded-lg border border-red-300 bg-red-50 px-3 py-1.5 text-xs font-semibold text-red-600 transition hover:bg-red-100 disabled:opacity-50"
                    >
                      <XCircle size={12} />
                      Missed
                    </button>
