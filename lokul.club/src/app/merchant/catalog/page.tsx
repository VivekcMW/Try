            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  value={editForm.kind}
                  disabled
                  className="w-full rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 text-base text-gray-500 outline-none cursor-not-allowed"
                >
                  {ITEM_KINDS.map((kind) => (
                    <option key={kind.value} value={kind.value}>
                      {kind.label}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-lg rounded-xl bg-white p-6 shadow-xl">
            ...
            {!importResult ? (
              <>
                ...
                <div className="mb-5">
                  ...
                  <input
                    ...
                    className="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-700 file:mr-3 file:rounded-md file:border-0 file:bg-blue-50 file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-blue-700 hover:file:bg-blue-100"
                  />
                  {importFile && (
              ...
              /* Results view */
              <>
                <div className={`mb-4 flex items-start gap-3 rounded-lg p-4 ${importResult.created > 0 ? "bg-green-50 border border-green-200" : "bg-yellow-50 border border-yellow-200"}`}>
