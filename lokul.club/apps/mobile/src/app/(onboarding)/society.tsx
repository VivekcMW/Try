...
export default function SocietyPickerScreen() {
  ...
  const results = useMemo(() => {
    ...
    // Boost societies in the same PIN.
  ...
  const submit = () => {
    ...
    router.push('/(onboarding)/tower-flat');
  };
  ...
  return (
    <Screen padded={false} keyboardAvoiding={false}>
      ...
      <View style={styles.footer}>
        ...
        <Pressable onPress={() => router.push('/(onboarding)/interests')} style={styles.skipLink}>
          <Text variant="body" tone="secondary" style={{ textAlign: 'center' }}>
