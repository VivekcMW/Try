...
export default function BranchesPage() {
      ...
      <div className="space-y-4">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              className="w-full rounded-md border border-gray-300 px-4 py-2.5 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            className="w-full rounded-md border border-gray-300 px-4 py-2.5 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 resize-none"
        ...
        {error && (
          <p className="rounded-md bg-red-50 px-4 py-2.5 text-sm text-red-700">{error}</p>
        )}
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onCancel}
            disabled={saving}
            className="flex-1 rounded-md border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 transition-colors"
          >
            Cancel
          </button>
        </div>
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      {/* Branch List */}
      {branches.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-md border-2 border-dashed border-gray-300 bg-gray-50 py-16 text-center">
          ...
          <button
            ...
            className="mt-6 inline-flex items-center gap-2 rounded-md bg-brand-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-700 transition-colors"
          >
            <Plus className="h-4 w-4" />
            Add First Branch
          </button>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 rounded-md border border-gray-200 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                    >
                      Cancel
                    </button>
                  </div>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="rounded-md border border-gray-200 p-1.5 text-gray-600 hover:bg-gray-50 transition-colors"
                        title="Edit branch"
                      >
