...
import { MapPin, TrendingUp, Sparkles, Filter, SlidersHorizontal } from 'lucide-react-native';
import { useRouter } from 'expo-router';
import { Card, HStack, Text, VStack, Badge } from '@/components/ui';
...
export default function CatalogScreen() {
  ...
  const handleMerchantPress = useCallback((merchantId: string, category: string) => {
    ...
    router.push(`/(merchant)/analytics?id=${merchantId}` as never);
  }, [track, router]);
      ...
      <VStack style={styles.container}>
        ...
        <VStack gap={1.5} style={styles.header}>
          <HStack gap={2} align="center" justify="space-between">
            ...
            <Pressable onPress={() => {}} accessibilityLabel="Filters">
              <SlidersHorizontal size={24} color={colors.surface.heading} />
            </Pressable>
          </HStack>
        ...
        {/* Tab switcher */}
        <HStack gap={2} style={styles.tabs}>
          <Pressable
